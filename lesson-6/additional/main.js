...
//
//
// let sortArray=coursesArray.sort((m1,m2)=>{
//     return m2.modules.length-m1.modules.length;
// });
...
// const stringSearch=(str,symb)=>{
//     let count=0;
//    let result=str.indexOf(symb);
//    while(result>-1){
//        count++;
//        result=str.indexOf(symb,result+1);
//    }
// console.log(count);
//
// }
// stringSearch('Астрономия это наука о небесных объектах','о');
