...
//     div.innerText = `${item.name} ${item.surname} ${item.age}`;
...
//     let divMonthDuraction = document.createElement('div');
//     divMonthDuraction.innerText = item.monthDuration;
//     let divHourDuraction = document.createElement('div');
//     divHourDuraction.innerText = item.hourDuration;
//     let modules = document.createElement('ul');
//
//     for (const elemModules of item.modules) {
//         let li = document.createElement('li');
//         li.innerText = elemModules;
//         modules.appendChild(li);
//     }
//
//     div.appendChild(modules);
//     div.appendChild(title);
//     div.appendChild(divMonthDuraction);
//     div.appendChild(divHourDuraction);
//     document.body.appendChild(div);
// }
